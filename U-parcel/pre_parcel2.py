...
from src.metrics import compute_metrics_detailed  # 计算指标


# ──────────────────── ❶ 手动填写路径 ────────────────────
ROOT_DATASET   = r"C:\Shandong\sddataset\dataset"         # 数据集根目录
CHECKPOINT_TAR = r"C:\utae-paps-main\utae-paps-main\sd_20\Fold_1\model.pth.tar"  # 训练好的权重
CONF_JSON      = r"C:\utae-paps-main\utae-paps-main\sd_20\conf.json"            # 训练时保存的配置
OUTPUT_CSV     = r"C:\FYgao\对比实验\add_epsd\ep2.csv"
OUTPUT_JSON    = r"C:\FYgao\对比实验\add_epsd\ep2.json"  # 用于保存指标的文件
        ...
        for imgs, dates, pid_raster, tgt, patch_ids in loader:
            ...
            for b, patch_id in enumerate(patch_ids):
                ...
                for pid in ids_in_patch:
                    ...
                    all_gts.append(int(pid))  # 在此示例中，gt 是 parcel_id
